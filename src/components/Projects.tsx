      ...
      <div className="max-w-[85rem] mx-auto relative z-10">
        ...
        <div className="flex flex-col gap-6 md:gap-10">
          {projects.map((project, idx) => (
            <motion.div
              key={idx}
              className="group relative border border-white/5 bg-white/[0.015] p-8 md:p-14 rounded-[2rem] overflow-hidden hover:bg-white/[0.03] transition-colors duration-500 cursor-pointer flex flex-col md:flex-row md:items-start justify-between gap-8"
